...
function renderDeepAnalysis(meta) {
  ...
  return `
    ...
    <div class="deep-grid">
      ...
      <p><strong>直说一句：</strong>${topRisk.hardTruth}</p>
...
function renderDimensionDetail(item) {
  return `
    <article class="detail-card">
      ...
      <p><strong>这个分数背后的代价：</strong>${item.cost}</p>
      <p><strong>不绕弯地说：</strong>${item.hardTruth}</p>
      <div class="practice-box">
        <strong>三步行动</strong>
        <ol>
      ...
      <p><strong>更适合你的建议：</strong>${item.advice}</p>
      <p><strong>可以继续想一想：</strong>${item.growthQuestion}</p>
    </article>
  `;
}
