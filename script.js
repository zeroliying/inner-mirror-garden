...
const pairProfiles = {
  ...
  "openness|action": {
    titles: ["数着星星不肯落地的满天星", "沿着很多方向攀爬的牵牛花"],
    voices: [
  ...
  "openness|responsibilityResilience": {
    titles: ["替风收下所有声音的薰衣草", "雪地里安静反省的白桦"],
    voices: [
  ...
  "responsibilityResilience|openness": {
    titles: ["愿意落叶却不轻易改根的梧桐", "听完风声仍守着香气的茉莉"],
    voices: [
...
function buildResultSummary(strengths, risks, meta) {
  ...
  return `
    <p><strong>${meta.title}。</strong>${meta.pairProfile.voice}</p>
